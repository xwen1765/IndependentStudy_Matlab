...
for k = 1 : length(alltrialsMS)
    if(~isempty(alltrialsMS{1,k}.microsaccades.start))
        ...
        for hB = 1 : length(alltrialsMS{1,k}.microsaccades.start)
            
            if((alltrialsMS{1,k}.microsaccades.start(hB) > 505 ...
                    && alltrialsMS{1,k}.microsaccades.start(hB) < 1141 ) && onlyCountOnce == 0)
...
% hB(1).FaceColor = [179,216,230]/255;
% hB(1).EdgeColor = [179,216,230]/255;
% hB(2).FaceColor = [242,176,110]/255;
% hB(2).EdgeColor = [242,176,110]/255;
...
ylabel('Task Acccuracy','FontSize',16);
legend("With MS","Without MS", 'FontSize', 20);
...
d = 100 * d;
bar(1, deltaMS, 'facecolor', [242,176,110]/255,'EdgeColor',[242,176,110]/255);
hold on;
bar(2, deltaNoMS, 'facecolor', [179,216,230]/255,'EdgeColor',[179,216,230]/255);
